...
//    convRepository.createConv(conv)
//
//    val msg1 = MessageNew("1", "msgTest", testUser1Id, testUser2Id)
//    convRepository.sendMessage(convId, msg1)
//    Shadows.shadowOf(Looper.getMainLooper()).idle()
//
//    val convAfterMsg = convRepository.getConv(convId)
//
//    assertNotNull(convAfterMsg)
//
//    assert(convAfterMsg.messages.isNotEmpty())
//    assertEquals(convAfterMsg.messages.first().msgId, msg1.msgId)
//
//
//
//  }
