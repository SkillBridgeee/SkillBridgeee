...
//  ) = Profile(id, name, email, location = location, description = desc)
//
//  private fun newVm(repo: ProfileRepository = FakeRepo()) =
//    MyProfileViewModel(profileRepository = repo, userId = "")
//
//  // -------- Tests --------------------------------------------------------
//
//  @OptIn(ExperimentalCoroutinesApi::class)
...
//
//    vm.setLocation(Location(name = "Paris"))
//    assertEquals("Paris", vm.uiState.value.selectedLocation?.name)
